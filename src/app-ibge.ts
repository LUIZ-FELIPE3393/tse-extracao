...
const isNumber = (value: any) => {  return typeof value === 'number' && Number.isFinite(value); }

async function getData(urlPath: string): Promise<AxiosResponse<any, any>> {
...
function writeFileCreateDir(filePath: string, data: string) {
...
async function parseCsvString(buffer: string): Promise<string> {
